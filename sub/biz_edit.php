...
<html lang="ko">
 <head>
  ...
  <style>
	...
	/*##### edit #####*/
		#edit_wrap{width:100%;}
		#edit_wrap h2{text-align:center; font-size:20px; padding:80px 0 20px;}
		#edit{width:1025px; margin:0 auto; padding-bottom:50px;}
		
		#edit form{width:100%;}
		#edit legend{display:none;}
		#edit .board{width:80%; margin:0 auto; border:none; border-top:1px solid #00564d; border-bottom:1px solid #00564d;}
		#edit .board p{width:50%; height:40px; line-height:40px; border-bottom:1px solid #ccc; float:left;}
		#edit .board .w100{width:100%;}
		#edit .board label{display:inline-block; width:100px; height:100%; margin-right:10px;background-color:#efefef; text-align:center; font-size:14px; vertical-align:top; letter-spacing:10px; text-indent:10px;}
		#edit .board label[for="pass"]{letter-spacing:3px; text-indent:3px;}
		#edit .board input:not([class="btn"]){text-indent:10px; font-family:'score400'; width:60%; border:1px solid #aaa; border-radius:3px;}
		#edit .board #name{border:none; outline:none;}
		#edit .board #title{width:80%;}
		#edit .board textarea{width:98%; height:500px; padding:1%; resize:vertical; font-family:'score400'; border:1px solid #aaa; border-radius:3px;}
		#edit .board .textArea{height:auto; border:none; text-align:center; padding:10px 0;}

		#edit .board:after{content:"";display:block; clear:both;}

		#btnArea{width:100%; padding-bottom:10px; text-align:right; clear:both;}
		#btnArea .btn{border:1px solid #ccc; border-radius:3px; font-size:12px; padding:2px 5px; cursor:pointer; background-color:#fff; font-family:'score400';}
	...
	/*##### 미디어쿼리 #####*/
		@media all and (min-width:320px) and (max-width:767px){
			...
			/*##### edit #####*/
				#edit_wrap h2{font-size:20px; padding:20px 0;}
				#edit{width:100%; max-width:480px;}
				#edit .board p{width:100%; float:none;}
				#edit .board label{width:30%;}
				#edit .board #title{width:60%;}
		}
  </style>
 </head>
 <body>
...
<?php }?>	
	...
	<div id="container">
		<section id="edit_wrap">
			<h2>게시글 수정</h2>
			<div id="edit">
				<form action="php/biz_edit_control.php?no=<?=$no?>" method="POST">
					<legend>글쓰기 영역 - 수정</legend>
...
<textarea id="content" name="content" title="내용">
<?=$row['content']?>
</textarea>
						</p>
						<div id="btnArea">
							<a class="btn" href="biz.php" title="목록">목록</a>
							<input class="btn" type="reset" value="다시쓰기" title="다시쓰기"/>
							<input class="btn" type="submit" value="저장" title="저장"/>	
						</div>
					</fieldset>
				</form>
			</div>
