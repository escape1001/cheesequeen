				...
				<form action="php/biz_write_control.php" method="POST">
					...
					<fieldset class="board">
						...
						<p>
							...
							<input id="name" type="text" name="name" required maxlength="8" placeholder="8자까지 입력"/>
						</p>
						<p>
							<label for="pass">비밀번호</label>
							<input id="pass" type="password" name="pass" required autocomplete="off" maxlength="10" placeholder="10자까지 입력">
						</p>
						<p class="w100 textArea">
<textarea id="content" name="content" title="내용" required>
</textarea>
						</p>
						<div id="btnArea">
							<a href="biz.php" title="목록">
								<input class="btn" type="button" value="목록" title="목록"/>
							</a>
