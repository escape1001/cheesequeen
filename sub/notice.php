		...
		<section id="biz_wrap">
			...
			<div id="biz">
				<section class="menu">
					<h3>고객센터</h3>
					<ul>
						<li class="selected"><a href="notice.php" title="공지페이지">공지사항<span>&gt;</span></a></li>
						<li><a href="faq.php" title="faq페이지">자주 묻는 질문<span>&gt;</span></a></li>
					</ul>
				</section>
				<ul class="board">
					<li class="thead">
...
?>
					<li>
						<p class="num"><?=$num+1?></p>
						<p class="title">
							<a href="notice_read.php?no=<?=$row['no']?>" title="게시글페이지"><?=$row['title']?></a>
						</p>
