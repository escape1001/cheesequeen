<?php
	...
	*/
	...
	session_start();
		...
		$sql = "SELECT * FROM faq ORDER BY no DESC";
 ...
 <head>
  ...
  <style>
	...
	/*##### biz #####*/
		...
		#biz .menu{width:20%; float:left;}
		#biz .menu h3{font-weight:400; padding-bottom:20px;}
		#biz .menu ul{width:80%; border:1px solid #ccc;}
		#biz .menu li{height:30px; line-height:30px; text-indent:10px;}
		#biz .menu li:first-child{border-bottom:1px solid  #ccc;}
		#biz .menu li a{display:block; width:100%; height:100%; position:relative; font-size:14px;}
		#biz .menu li a span{position:absolute; right:10px;}
		#biz .menu .selected a{color:#00564d;}
		
		#biz .board{width:80%; margin:0 auto; border-top:1px solid #00564d; border-bottom:1px solid #00564d; float:left;}
		#biz .board li{width:100%; height:30px; line-height:30px; border-top:1px solid #eee; font-size:14px; text-align:center; color:#777;}
		#biz .board li p{display:block; float:left; overflow:hidden;}
		#biz .board li .num{width:10%;}
		#biz .board li .title{width:42%; text-align:left; text-indent:10px; white-space:nowrap; text-overflow:ellipsis;}
		#biz .board li .name{width:15%; color:#333;}
		#biz .board li .wdate{width:23%;}
		#biz .board li .view{width:10%;}
		#biz .board .thead{border-top:none; border-bottom:1px solid #777; font-family:'score500'; color:#333;}
		#biz .board .thead .title{text-align:center; text-indent:0;}
	...
	/*##### 미디어쿼리 #####*/
		@media all and (min-width:320px) and (max-width:767px){
			...
			/*##### biz #####*/
				...
				#biz .menu{width:100%; float:none;}
				#biz .menu h3{display:none;}
				#biz .menu ul{width:80%; max-width:270px; margin:0 auto;}
				
				#biz .board{width:80%; margin:20px auto 0; border-top:1px solid #00564d; border-bottom:1px solid #00564d; float:none;}
				#biz .board li{font-size:12px;}
				#biz .board li .num{width:10%;}
				#biz .board li .title{width:70%;}
				#biz .board li .name{width:20%;}
				#biz .board li .wdate{display:none;}
				#biz .board li .view{display:none;}
		}
  </style>
 </head>
 <body>
		...
		<section id="biz_wrap">
			...
			<div id="biz">
				<section class="menu">
					<h3>고객센터</h3>
					<ul>
						<li><a href="notice.php" title="공지페이지">공지사항<span>&gt;</span></a></li>
						<li class="selected"><a href="faq.php" title="faq페이지">자주 묻는 질문<span>&gt;</span></a></li>
					</ul>
				</section>
				<ul class="board">
					<li class="thead">
...
?>
					<li>
						<p class="num"><?=$num+1?></p>
						<p class="title">
							<a href="faq_read.php?no=<?=$row['no']?>" title="게시글페이지"><?=$row['title']?></a>
						</p>
