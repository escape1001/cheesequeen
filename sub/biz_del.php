...
<html lang="ko">
 <head>
  ...
  <style>
	...
	/*##### delete #####*/
		#del_wrap{width:100%;}
		#del_wrap h2{text-align:center; font-size:20px; padding:80px 0 20px;}
		#del{width:1025px; margin:0 auto; padding-bottom:50px;}
		
		#del form{width:100%;}
		#del legend{display:none;}
		#del .board{width:80%; margin:0 auto; border:none;}
		#del .board p{width:100%; text-align:center;}
		#del .board label{display:block; width:100%; height:30px; font-size:14px; vertical-align:top;}
		#del .board label[for="pass"]{letter-spacing:3px; text-indent:3px;}
		#del .board input:not([class="btn"]){text-indent:10px; font-family:'score400'; width:50%; border:1px solid #aaa; border-radius:3px;}

		#del .board:after{content:"";display:block; clear:both;}

		#btnArea{width:100%; padding-top:10px; text-align:center; clear:both;}
		#btnArea .btn{border:1px solid #ccc; border-radius:3px; font-size:12px; padding:2px 5px; cursor:pointer; background-color:#fff;}
	...
	/*##### 미디어쿼리 #####*/
		@media all and (min-width:320px) and (max-width:767px){
			...
			/*##### del #####*/
				#del_wrap h2{font-size:20px; padding:20px 0;}
				#del{width:100%; max-width:480px;}
				#del .board p{width:100%; float:none;}
				#del .board #title{width:60%;}
		}
  </style>
 </head>
 <body>
...
<?php }?>	
	...
	<div id="container">
		<section id="del_wrap">
			<h2>게시글 삭제</h2>
			<div id="del">
				<form action="php/biz_del_control.php?no=<?=$no?>" method="POST">
					<legend>글쓰기 영역 - 수정</legend>
					<fieldset class="board">
						<p>
							<label>비밀번호를 입력하세요.</label>
							<input id="pass" type="password" name="pass" required autocomplete="off" maxlength="10" placeholder="10자까지 입력 가능">
						</p>
						<div id="btnArea">
							<a class="btn" href="biz.php" title="취소">취소</a>
							<input class="btn" type="submit" value="확인" title="확인"/>	
						</div>
					</fieldset>
				</form>
			</div>
