 ...
 <head>
  ...
  <style>
	...
	/*##### notice #####*/
		...
		#notice_wrap h2{text-align:center; font-size:20px; padding:80px 0 20px;}
		#notice{width:1025px; margin:0 auto; padding-bottom:50px;}

		#notice .board{width:80%; margin:0 auto; border-top:1px solid #00564d; border-bottom:1px solid #00564d;}
		#notice .board p{width:50%; height:40px; line-height:40px; border-bottom:1px solid #ccc; float:left;}
		#notice .board .w100{width:100%;}
		#notice .board label{display:inline-block; width:100px; height:100%; background-color:#efefef; text-align:center; font-size:14px; vertical-align:top; letter-spacing:10px; text-indent:10px;}
		#notice .board input{border:none; outline:none; text-indent:10px; font-family:'score400';}
		#notice .board img{width:100%;}
		/*#notice .board textarea{width:98%; padding:1%; resize:none; border:none; outline:none; font-family:'score400';}*/
		#notice .board p:last-child{height:auto; border:none;}

		#notice .board:after{content:"";display:block; clear:both;}

		#notice #btnArea{width:80%; margin:0 auto; padding-top:10px;text-align:right;}
	...
	/*##### 미디어쿼리 #####*/
		@media all and (min-width:320px) and (max-width:767px){
			...
			/*##### notice #####*/
				#notice_wrap h2{font-size:20px; padding:20px 0;}
				#notice{width:100%; max-width:480px;}
				#notice .board p{width:100%; float:none;}
				#notice .board label{width:30%;}
				#notice .board input{width:60%;}
				#notice .board #title{width:60%;}
		}
  </style>
 </head>
 <body>
			...
			<div id="notice">	
				<div class="board">
					<p class="w100">
						...
						<input id="title" type="text" name="title" value="비지니스 회원가입 안내" readonly/>
					</p>
					<p>
						<label for="name">이름</label>
						<input id="name" type="text" name="name" value="치즈퀸" readonly/>
					</p>
					<p>
						<label for="wdate">날짜</label>
						<input id="wdate" type="text" name="wdate" value="2021-04-10 16:03:00" readonly/>
					</p>
					<p class="w100">
						<img src="../img/sub/biz/biz_notice0.jpg" alt="biz_공지이미지"/>
<!--<textarea id="content" name="content" readonly title="내용">
</textarea>-->
					</p>
				</div>
				<div id="btnArea">
					<!--<a href="biz_del.php?no=<?=$no?>" title="삭제">삭제</a>
					<a href="biz_edit.php?no=<?=$no?>" title="수정">수정</a>-->
					<a href="biz.php" title="글쓰기">목록</a>
				</div>
			</div>
		</section>
		<div id="fixed_wrap">
